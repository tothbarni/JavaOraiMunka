...
public class RobotokTippelnekGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        chbKulonbozo = new javax.swing.JCheckBox();
        ...
        chbKulonbozo.setSelected(true);
        chbKulonbozo.setText("Különböző számok");
    ...
    private void btnGeneralActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGeneralActionPerformed
        ...
        if (also > felso) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Felcseréltem a két számot!");
        }
        txtVelSzam1.setText(szam1 + "");
        txtVelSzam2.setText(szam1 + "");
        
        if (chbKulonbozo.isSelected()){
        ...
        jButton1.setActionCommand(String.valueOf(szam1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int szam1 = Integer.parseInt(evt.getActionCommand());

        int tipp1 = (int)(Math.random() * 10) + 1;
        int tipp2 = (int)(Math.random() * 10) + 1;
        int tipp3 = (int)(Math.random() * 10) + 1;

        jTextArea1.append("A kitalálandó szám: " + szam1 + "\n");
        ...
        if (tipp1 == szam1) {
            voltTalalat = true;
            jTextArea1.append("Az 1. robot eltalálta!\n");
        }
        if (tipp2 == szam1) {
            voltTalalat = true;
            jTextArea1.append("A 2. robot eltalálta!\n");
        }
        if (tipp3 == szam1) {
            voltTalalat = true;
            jTextArea1.append("A 3. robot eltalálta!\n");
        }
        if (!voltTalalat) {
            jTextArea1.append("Egyik robot sem találta el!\n");
        }
    ...
    private javax.swing.JCheckBox chbKulonbozo;
